...
if ( ! function_exists( 'smak_setup' ) ) :
	...
	function smak_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'smak' ),
		) );
...
function smak_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'smak_content_width', 640 );
}
...
function smak_scripts() {
	...
	wp_enqueue_script( 'smak-tether', get_template_directory_uri() . '/src/js/tether.min.js', array('jquery'), '20170115', true );
	...
	wp_enqueue_script( 'smak-google', 'https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js');
	
	wp_enqueue_script( 'smak-bootstrap-js', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js');
	
	wp_enqueue_style( 'smak-fonts-awesome', get_template_directory_uri() . '/font-awesome/css/font-awesome.min.css' );
	
	wp_enqueue_style( 'smak-isotope-style', get_template_directory_uri() . '/css/isptope_style.css', '20140328', true );
	
	wp_enqueue_style( 'smak-jquerysctipttop', 'http://www.jqueryscript.net/css/jquerysctipttop.css');
	
	wp_enqueue_style( 'smak-progressbar', get_template_directory_uri() . '/css/jQuery-plugin-progressbar.css', '20140328', true );
	
	wp_enqueue_script( 'smak-isotope-jquery', get_template_directory_uri() . '/js/jquery.isotope.js', array('jquery'), '20140328', true );
	
	
	
	wp_enqueue_script( 'smak-progressbarJS', get_template_directory_uri() . '/js/jQuery-plugin-progressbar.js', array('jquery'), '20170915', true );
