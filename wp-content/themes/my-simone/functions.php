<?php
/**
 * shaban functions and definitions
 *
 * @package shaban
 */
...
if ( ! function_exists( 'shaban_setup' ) ) :
/**
 ...
 */
function shaban_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on shaban, use a find and replace
	 * to change 'shaban' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'shaban', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'shaban' ),
		'social' => __( 'Social Menu', 'shaban'),
	) );
	...
	//add_theme_support( //'custom-background', //apply_filters( //'shaban_custom_background_args//', array(
...
add_action( 'after_setup_theme', 'shaban_setup' );

/**
 * Register widgetized area and update sidebar with default widgets.
 */
function shaban_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'shaban' ),
		'id'            => 'sidebar-1',
...
add_action( 'widgets_init', 'shaban_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function shaban_scripts() {
	wp_enqueue_style( 'shaban-style', get_stylesheet_uri() );
