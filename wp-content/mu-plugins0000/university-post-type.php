...
// Register Custom Post Type
function professors_post_type() {

	$labels = array(
		'name'                  => _x( 'professor', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'professor', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'professors', 'text_domain' ),
		'name_admin_bar'        => __( 'professors', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'professor', 'text_domain' ),
		'description'           => __( 'Post Type Description', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'professors_post_type', 0 );
